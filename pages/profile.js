...
export default function Profile() {
  ...
  useEffect(() => {
   if (activeTab !== "courses" && activeTab !== "progress") return;
            ...
            {activeTab === "profile" && (
              <>
                ...
                <section className="profile-section profile-section--dark">
                  <div className="profile-section__head">
                    <div>
                      <p className="profile-section__label">03 — Security</p>
            ...
            {activeTab === "courses" && (
              <>
                ...
                {/* <div className="profile-sidebar__card">
                  ...
                  <div className="profile-overview-grid profile-overview-grid--4col">
                ...
                <section className="profile-section">
                  <div className="profile-section__head">
                    <div>
                      <p className="profile-section__label">Account</p>
        ...
        return (
          ...
          >
            ...
            <div className="exercise-progress-top">
              ...
              <h3>
                {course.label || course.title || "Exercise"}
              </h3>
            ...
            <div className="exercise-progress-bottom">
